...
$this->breadcrumbs = array(
    'Фотоальбомы' => \Yii::app()->createUrl('/gallery/album/index_video', array('gameId' => \Yii::app()->userOwn->game_id)),
    $album->title
);
...
<div class="buttons" style="padding-left: 6px;">
    <div class="m_button">
        <?php echo CHtml::link('Добавить видео', Yii::app()->createUrl('/gallery/video/add', array('album_id' => $album->id)), array('id' => 'add_video', 'class' => 'fancybox.ajax btn2')); ?>
    </div>
    <div class="m_button">
        <?php echo CHtml::link(
            'Редактировать альбом',
            Yii::app()->createUrl('/gallery/album/update_video', array('album_id' => $album->id, 'gameId' => Yii::app()->user->getGameId())
            ),
    ...
    <div class="m_button">
        <?php echo CHtml::link(
            'Удалить альбом',
            Yii::app()->createUrl('/gallery/album/delete_video', array('album_id' => $album->id, 'gameId' => Yii::app()->user->getGameId())),
