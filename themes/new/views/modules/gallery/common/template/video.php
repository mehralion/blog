...
<article class="long_block">
    ...
    <div class="info">
        ...
        <div class="right">
            ...
            <a href="<?php echo Yii::app()->createUrl('/gallery/video/show', array('id' => $model->id, 'gameId' => $model->user->game_id)); ?>"><span class="commentCount">Комментарии <?php echo $model->comment_count; ?></span></a>
        </div>
    </div>
</article>