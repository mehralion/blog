...
<article class="short_block">
        ...
        <figure class="img_border">
            <?php
                echo CHtml::link(
                    ...
                    Yii::app()->createUrl('/community/image/show', array(
                        'id' => $model->id,
    ...
    <div class="info">
        ...
        <a href="<?php echo Yii::app()->createUrl('/community/image/show', array('id' => $model->id, 'community_alias' => $model->community_alias)); ?>">
