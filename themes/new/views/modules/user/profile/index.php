...
?>
    ...
    <div class="clear"></div>
        ...
        ?>
    <?php if($model->userDj !== null): $model->bank = $model->userDj->game_bank; ?>
    <div class="">
        <?php echo $form->textFieldRow($model, 'bank', array('placeholder' => 'Номер счета', 'labelOptions' => array('label' => false))); ?>
    </div>
    <?php endif; ?>
