...
<article class="long_block">
    <div class="title"><i class="icon" id="shield"></i><?php echo CHtml::link(
            ...
            Yii::app()->createUrl(
                '/community/post/show',
                array('id' => $model->post->id, 'community_alias' => $model->post->community_alias)
            )); ?></div>
    <div class="content">
    ...
    <div class="info">
        ...
        <div class="right">
            <span class="ratingCount ajax"><?php echo $model->post->canRate(); ?>
                <span class="showRate ajax" data-link="<?php echo Yii::app()->createUrl('/community/post/listrate', array('id' => $model->item_id, 'community_alias' => $model->post->community_alias)); ?>" data-html="true" rel="tooltip" title="<?php echo $model->post->getRateList(); ?>">Понравилось
                    <span id="post_<?php echo $model->id; ?>"><?php echo $model->post->rating; ?></span>
                </span>
            </span>
            <a href="<?php echo Yii::app()->createUrl('/community/post/show', array('id' => $model->post->id, 'community_alias' => $model->post->community_alias)); ?>">
