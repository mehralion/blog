...
<?php $this->widget('bootstrap.widgets.TbGridView', array(
    ...
    'columns'=>array(
        ...
        array(
            ...
            'buttons' => array(
                'reset' => array(
                    'url' => 'Yii::app()->createUrl("/moder/image/reset", array("id" => $data->id))',
                    'label' => 'Отклонить'
                ),
                'view' => array(
                    'options' => array(
                    ...
                    'url' => 'Yii::app()->createUrl("/preview/image", array("id" => $data->item_id))',
                ),
                'update' => array(
                    'url' => 'Yii::app()->createUrl("/moder/image/accept", array("id" => $data->id))',
                    'label' => 'Удалить',
                    'options' => array(
