...
<article class="long_block">
    <h3 class="title">
        ...
        <a href="<?php echo Yii::app()->createUrl('/post/index/show', array('id' => $model->id, 'gameId' => $model->user->game_id)); ?>">
            <?php
                $text = Yii::app()->stringHelper->setBR(Yii::app()->stringHelper->parseTag($model->title));
                echo Yii::app()->stringHelper->subStringNew($text, 70, '...');
            ?>
        </a>
    </h3>
    <div class="content">
    ...
    <div class="info">
        <div class="left">
            <span class="author"><?php echo $model->user->getFullLogin(false, $model->login); ?></span>
