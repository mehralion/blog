...
?>
    <ul class="friend">
        <?php foreach ($models as $model): ?>
            <li>
                <?php $this->renderPartial('webroot.themes.' . Yii::app()->theme->name . '.views.modules.subscribe.common.community', array(
                        'model' => $model,
                    )); ?>
            </li>
        <?php endforeach; ?>
...
<?php if (empty($models)): ?>
    <div class="event_empty">
        ...
        Для того, чтобы подписаться, зайдите на страницу сообщества и нажмите "Подписаться".
    </div>
<?php endif; ?>
