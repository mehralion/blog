    ...
    <div class="content event_comment">
        ...
        <div class="description comment_preview">
            <div class="img_border">
                <?php echo CHtml::link(
                    CHtml::image('http://img.youtube.com/vi/'.$model->info->file_name.'/2.jpg'),
                    Yii::app()->createUrl(
    ...
    <div class="info">
        ...
        <div class="right">
            <span class="ratingCount ajax"><?php echo $model->comment->canRate(); ?>
                <span class="showRate ajax" data-link="<?php echo Yii::app()->createUrl('/community/listrate/comment_video', array('id' => $model->comment_id, 'community_alias' => $model->info->community_alias)); ?>" data-html="true" rel="tooltip" title="<?php echo $model->comment->getRateList(); ?>">Понравилось
