...
<article class="long_block">
    <h3 class="title">
        ...
        <a href="<?php echo Yii::app()->createUrl('/community/post/show', array('id' => $model->id, 'community_alias' => $model->community_alias)); ?>">
            <?php
    ...
    <div class="info">
        ...
        <div class="right">
            ...
            <a href="<?php echo Yii::app()->createUrl('/community/post/show', array('id' => $model->id, 'community_alias' => $model->community_alias)); ?>"><span class="commentCount">Комментарии <?php echo $model->comment_count; ?></span></a>
        </div>
    </div>
</article>