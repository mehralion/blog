...
<?php $this->widget('bootstrap.widgets.TbGridView', array(
    ...
    'columns'=>array(
        ...
        array(
            ...
            'buttons' => array(
                'reset' => array(
                    'url' => 'Yii::app()->createUrl("/moder/community/reset", array("id" => $data->id))',
                    'label' => 'Отклонить'
                ),
                'view' => array(
                    'options' => array(
                    ...
                    'url' => 'Yii::app()->createUrl("/preview/community", array("id" => $data->item_id))',
                ),
                'update' => array(
                    'url' => 'Yii::app()->createUrl("/moder/community/accept", array("id" => $data->id))',
                    'label' => 'Удалить',
                    'options' => array(
