<?php
class CacheEventItemAudio extends CacheEventItem
{
    /**
    ...
    public static function updateByItemId($id)
    {
        return self::model()->updateAll(
            ...
            array(':item_id' => $id, ':item_type' => ItemTypes::ITEM_TYPE_AUDIO_ALBUM)
        );
    }
    ...
    public static function updateAllByAlbumId($id)
    {
        return self::model()->updateAll(
            ...
            array(':album_id' => $id, ':item_type' => ItemTypes::ITEM_TYPE_AUDIO_ALBUM)
        );
    }
}