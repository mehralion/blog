...
class Image extends \CAction
{
    public function run()
    {
        ...
        /** @var \CommentItemImage $CommentItem */
        ...
        if($post) {
            ...
            try {
                ...
                $GalleryImage = \GalleryImage::model()->findByPk($CommentItem->item_id);
                if($GalleryImage->comment_count > 0)
                    $GalleryImage->comment_count -= 1;
                $GalleryImage->update_datetime = \DateTimeFormat::format();
