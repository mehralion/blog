...
*/
    protected function defaults()
    {
        ...
        isset($this->options['setOptions'][CURLOPT_COOKIEJAR]) ? $this->setOption(CURLOPT_COOKIEJAR, $this->options['setOptions'][CURLOPT_COOKIEJAR]) : $this->setOption(CURLOPT_COOKIEJAR, ROOT_DIR.'/cookie/oldbk.txt');
        isset($this->options['setOptions'][CURLOPT_COOKIEFILE]) ? $this->setOption(CURLOPT_COOKIEFILE, $this->options['setOptions'][CURLOPT_COOKIEFILE]) : $this->setOption(CURLOPT_COOKIEFILE, ROOT_DIR.'/cookie/oldbk.txt');
        isset($this->options['setOptions'][CURLOPT_USERAGENT]) ? $this->setOption(CURLOPT_USERAGENT, $this->options['setOptions'][CURLOPT_USERAGENT]) : $this->setOption(CURLOPT_USERAGENT, 'Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.8.1.13) Gecko/20080311 Firefox/2.0.0.13');
    }
